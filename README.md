...
didn't fit into any of the classes is found,  we obtain the emedding of the text and then find the sentence similarity between the sentence and the stored sentences from both class.
